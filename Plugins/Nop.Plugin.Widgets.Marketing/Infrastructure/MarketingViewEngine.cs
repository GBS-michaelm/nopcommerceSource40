...
{
    public class MarketingViewEngine : ThemeableRazorViewEngine
    {
        public MarketingViewEngine()
        {
        ...
        public void AddViewLocationFormats()
        {
            var additionalViewLocationFormats = new List<string>()
              {
                "~/Plugins/Widgets.Marketing/Views/{0}.cshtml",
                "~/Plugins/Widgets.Marketing/Views/{1}/{0}.cshtml"
              };
