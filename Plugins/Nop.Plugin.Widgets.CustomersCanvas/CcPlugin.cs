...
namespace Nop.Plugin.Widgets.CustomersCanvas
{
    public class CcPlugin : BasePlugin, IWidgetPlugin, IAdminMenuPlugin
    {
        ...
        private readonly ISpecificationAttributeService
        ...
        private void InstallLanguageResources()
        {
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.CustomersCanvas.Config.CCApiKey", 
                "Customer's Canvas Api Security Key");
        ...
        private void RemoveLanguageResources()
        {
            this.DeletePluginLocaleResource("Plugins.Widgets.CustomersCanvas.Config.CCApiKey");
        ...
        public void GetPublicViewComponent(string widgetZone, out string viewComponentName)
        {
            switch (widgetZone)
            {
                case "orderdetails_product_line":
                    viewComponentName = "OrderDetails";
                    break;
                case "productdetails_bottom":
                    viewComponentName = "ProductDetailsBottom";
                    break;
                case "productdetails_add_info":
                    viewComponentName = "ProductDetailsAddInfo";
                    break;
                case "order_summary_content_after":
                    viewComponentName = "OrderSummaryContent";
                    break;
                case "head_html_tag":
                    viewComponentName = "HtmlHead";
                    break;
                case "product_editor_page":
                    viewComponentName = "ProductEditorPage";
                    break;
                case "admin_order_list_buttons":
                    viewComponentName = "AdminOrderListButtons";
                    break;
                default:
                    viewComponentName = "";
                    break;
        ...
        {
            return _webHelper.GetStoreLocation() + "Admin/CcConfig/Configure";
        }
        ...
        public IList<string> GetWidgetZones()
        {
            return new List<string>
            {
                ...
                "admin_order_list_buttons"   // на странице Orders в админке добавление кнопки
            };
        }
        #endregion
