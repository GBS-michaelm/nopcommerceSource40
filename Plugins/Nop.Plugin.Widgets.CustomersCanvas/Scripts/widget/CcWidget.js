var CcWidget = (function () {
    ...
    CcWidget.prototype._getCartItemsData = function () {
        ...
        $.ajax({
            cache: false,
            url: ccWidgetBaseUrl + "ccwidget/getcartitemsdata",
            data: {},
            type: "get",
            ...
            error: function (xhr, textStatus, thrownError) {
                console.error("filed to load " + ccWidgetBaseUrl + "ccwidget/getcartitemsdata", textStatus, xhr.status, thrownError, xhr.responseText);
            }
        });
    };
