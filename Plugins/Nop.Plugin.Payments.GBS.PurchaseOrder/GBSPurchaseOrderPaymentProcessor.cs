...
using Nop.Plugin.Payments.GBS.PurchaseOrder.Controllers;
...
namespace Nop.Plugin.Payments.GBS.PurchaseOrder
{
    ...
    public class GBSPurchaseOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "GBSPaymentPurchaseOrder";
            routeValues = new RouteValueDictionary { { "Namespaces", "Nop.Plugin.Payments.GBS.PurchaseOrder.Controllers" }, { "area", null } };
        }
        ...
        {
            return typeof(GBSPaymentPurchaseOrderController);
        }
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.PurchaseOrder.PurchaseOrderName", "Name");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.PurchaseOrder.PurchaseOrderPhoneNumber", "Phone Number");
