...
namespace Nop.Plugin.Payments.GBS.PurchaseOrder
{
    /// <summary>
    /// PurchaseOrder payment processor
    /// </summary>
    public class GBSPurchaseOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        #region Fields
        ...
        private readonly GBSPurchaseOrderPaymentSettings _purchaseOrderPaymentSettings;
        ...
        public GBSPurchaseOrderPaymentProcessor(ILocalizationService localizationService,
            IOrderTotalCalculationService orderTotalCalculationService,
            ISettingService settingService,
            GBSPurchaseOrderPaymentSettings purchaseOrderPaymentSettings,
        ...
        {
            return _webHelper.GetStoreLocation() + "Admin/GBSPaymentPurchaseOrder/Configure";
        }
        ...
        public ProcessPaymentRequest GetPaymentInfo(IFormCollection form)
        {
            ...
            _httpContextAccessor.HttpContext.Session.SetString("purchaseOrderNumber", form["PurchaseOrderNumber"]);
            _httpContextAccessor.HttpContext.Session.SetString("purchaseOrderName", form["PurchaseOrderName"]);
            _httpContextAccessor.HttpContext.Session.SetString("purchaseOrderPhoneNumber", form["PurchaseOrderPhoneNumber"]);
            return paymentInfo;
        }
        ...
        {
            viewComponentName = "PaymentGBSPurchaseOrder";
        }
        ...
        {
            //settings
            _settingService.SaveSetting(new GBSPurchaseOrderPaymentSettings());
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.PurchaseOrder.PurchaseOrderName", "PO Name");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.PurchaseOrder.PurchaseOrderPhoneNumber", "PO Phone");
        ...
        {
            //settings
            _settingService.DeleteSetting<GBSPurchaseOrderPaymentSettings>();
            ...
            this.DeletePluginLocaleResource("Plugins.Payment.PurchaseOrder.PurchaseOrderName");
            this.DeletePluginLocaleResource("Plugins.Payment.PurchaseOrder.PurchaseOrderPhoneNumber");
