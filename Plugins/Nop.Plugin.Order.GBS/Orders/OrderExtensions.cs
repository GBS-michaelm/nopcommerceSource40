...
namespace Nop.Plugin.Order.GBS.Orders
{
	public class OrderExtensions
    {
        ...
        //public GBSOrderService _gbsOrderService = EngineContext.Current.Resolve<GBSOrderService>();  //(GBSOrderService)DependencyResolver.Current.GetServices<IOrderService>().Where(x => x is GBSOrderService).FirstOrDefault();
