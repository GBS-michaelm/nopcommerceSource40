...
namespace Nop.Plugin.Products.SpecificationAttributes
{
    ...
    public class ProductSpecificationAttributeProcessor : BasePlugin, IWidgetPlugin
    {
        ...
        public override void Uninstall()
        {
            ...
            //if (artistAttr != null)
            //{
            //    _specificationAttributeService.DeleteSpecificationAttribute(artistAttr);
            //}
            //var DefaultEnvelopeColorAttr = _specificationAttributeService.GetSpecificationAttributes().Where(x => x.Name == "DefaultEnvelopeColor").FirstOrDefault();
            //if (DefaultEnvelopeColorAttr != null)
            //{
            //    _specificationAttributeService.DeleteSpecificationAttribute(DefaultEnvelopeColorAttr);
            //}
            //var OrientationAttr = _specificationAttributeService.GetSpecificationAttributes().Where(x => x.Name == "Orientation").FirstOrDefault();
            //if (OrientationAttr != null)
            //{
            //    _specificationAttributeService.DeleteSpecificationAttribute(OrientationAttr);
            //}

            this.DeletePluginLocaleResource("Plugin.ProductArtist.ArtistName");
            this.DeletePluginLocaleResource("Plugin.ProductArtist.ArtistName.Hint");
            this.DeletePluginLocaleResource("Plugin.Product.Atist");
            this.DeletePluginLocaleResource("Plugin.Artist.Saved");
