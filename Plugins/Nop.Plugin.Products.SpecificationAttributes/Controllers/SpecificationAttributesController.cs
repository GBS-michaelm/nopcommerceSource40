...
namespace Nop.Plugin.Products.SpecificationAttributes.Controllers
{
	public class SpecificationAttributesController : BasePluginController
    {
        ...
        [HttpPost]
        public IActionResult Configure(ConfigureModel model)
        {
        ...
        public IActionResult ProductTab(int id)
        {
        ...
        [HttpPost]
        public IActionResult ProductTabPost(int id, string ArtistName)
        {
            var product = _productService.GetProductById(id);
            if (product != null)
            {
        ...
        public IActionResult OrderListing(IEnumerable<Nop.Web.Models.Order.CustomerOrderListModel.OrderDetailsModel> list)
        {
        ...
        public IActionResult OrderProductImage(OrderItem orderItem)
        {
        ...
        public IActionResult ArtistProducts(int productId)
        {
        ...
        public IActionResult ArtistCategory(int specs, CatalogPagingFilteringModel command)
        {
            var artistAttr = _specificationAttributeService.GetSpecificationAttributes().Where(x => x.Name == "Artist").FirstOrDefault();
            if (artistAttr != null)
            {
        ...
        public IActionResult CategoryImage(string widgetZone, object additionalData = null)
        {
        ...
        [HttpPost]
        public IActionResult GoToOrderId(string selectedIds)
        {
        ...
        public JsonResult GetTierPrice(int quantity, int productID)
        {
            ...
            return Json(finalprice.ToString("0.00"));
        }
        #region Utilities
